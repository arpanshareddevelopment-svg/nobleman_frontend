...
const instructors = [
  { init: "RK", name: "Rahul Kumar", email: "rahul@acme.com", tenant: "Acme LMS", courses: 6, students: 420, rating: 4.8, status: "Active", gradient: "from-blue-500 to-blue-400" },
  { init: "PS", name: "Priya Singh", email: "priya@edge.com", tenant: "EdgeLearn", courses: 4, students: 220, rating: 4.6, status: "Active", gradient: "from-emerald-500 to-emerald-400" },
  { init: "AM", name: "Arjun Mehta", email: "arjun@bright.com", tenant: "BrightPath", courses: 3, students: 120, rating: 4.3, status: "Active", gradient: "from-amber-500 to-amber-400" },
  { init: "NK", name: "Neha Kapoor", email: "neha@skillhub.com", tenant: "SkillHub", courses: 8, students: 640, rating: 4.9, status: "Active", gradient: "from-purple-500 to-purple-400" },
  { init: "VR", name: "Vikram Rao", email: "vikram@learnpro.com", tenant: "LearnPro", courses: 2, students: 80, rating: 4.1, status: "Inactive", gradient: "from-rose-500 to-rose-400" },
];

const stats = [
  { icon: <GraduationCap size={18} />, label: "Total Instructors", val: "42", sub: "Across all tenants", bg: "bg-blue-100", text: "text-blue-600" },
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[var(--border)] bg-white/50">
                {["Instructor", "Tenant", "Courses", "Students", "Rating", "Status", "Actions"].map((h) => (
            ...
            <tbody>
              {instructors.map((i) => (
                <tr key={i.email} className="border-b border-[var(--border)] hover:bg-white/40 transition-colors">
                  ...
                  <td className="px-4 py-3 text-[var(--fg-secondary)] text-xs">{i.tenant}</td>
